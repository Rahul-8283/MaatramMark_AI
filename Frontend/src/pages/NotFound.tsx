...
export default function NotFound() {
  return (
    <div className="h-[calc(100vh-73px)] bg-[#050505] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-lg -mt-20">
